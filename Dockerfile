...
RUN DEBIAN_FRONTEND=noninteractive apt-get update && apt-get install -y \
  ...
  libavformat56=6:11.11-1~deb8u1 \
  libavdevice-dev=6:11.11-1~deb8u1 \
  libavdevice55=6:11.11-1~deb8u1 \
  libavfilter-dev=6:11.11-1~deb8u1 \
  libavfilter5=6:11.11-1~deb8u1 \
  libavresample-dev=6:11.11-1~deb8u1 \
  libavresample2=6:11.11-1~deb8u1 \
  libavutil-dev=6:11.11-1~deb8u1 \
  libavutil54=6:11.11-1~deb8u1 \
  libswscale-dev=6:11.11-1~deb8u1 \
  libswscale3=6:11.11-1~deb8u1 \
